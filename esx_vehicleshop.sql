...
INSERT INTO `addon_inventory` (name, label, label_sc, label_tc, shared) VALUES
	('society_cardealer','Cardealer','汽车经销商','載具經銷商',1)
;

INSERT INTO `jobs` (name, label, label_sc, label_tc) VALUES
	('cardealer','Cardealer','汽车经销商','載具經銷商')
;

INSERT INTO `job_grades` (job_name, grade, name, label, label_sc, label_tc, salary, skin_male, skin_female) VALUES
	('cardealer',0,'recruit','Recruit','实习生','實習生',10,'{}','{}'),
	('cardealer',1,'novice','Novice','正式员工','正式員工',25,'{}','{}'),
	('cardealer',2,'experienced','Experienced','经理','經理',40,'{}','{}'),
	('cardealer',3,'boss','Boss','老板','老闆',0,'{}','{}')
;
